...
function Club_Migrate_4() {
    ...
    if (($info = Club_Schema_Column('activities', 'polled')) === false) Club_Migrate_Exec('activities add polled', 'alter table `activities` add `polled` int not null default 0 after `updated`');
