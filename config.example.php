<?php $config = [
    ...
    'worker' => [
        // 投递按用途隔离；同一 endpoint 仍只放一个请求在途，并按 follow、notice、announce、relay 的顺序取当前已到期任务
        // 每类至少一个，慢实例能占住一个进程十几秒，进程数超过该类可领的 endpoint 数就是纯空转
        'delivery' => ['follow' => 2, 'notice' => 2, 'announce' => 2, 'relay' => 2],
